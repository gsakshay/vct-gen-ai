...
import RouterLink from "./wrappers/router-link.js";
        ...
        items: sessions.map( session => ( {
          ...
          info: <Box margin="xxs" textAlign="center" >
            <SpaceBetween size="xs">
              <RouterLink href={"/chatbot/sessions"}>
                <Button loading={loadingSessions} variant="link">VIEW ALL SESSIONS</Button>
              </RouterLink>
              <Button onClick={onReloadClick} iconName="refresh" loading={loadingSessions} variant="link">RELOAD SESSION</Button>
            </SpaceBetween>
          </Box>
        }] ),
      },
