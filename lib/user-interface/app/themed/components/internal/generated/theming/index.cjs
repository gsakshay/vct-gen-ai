module.exports.preset = {
  ...
  "propertiesMap": {
    ...
    "colorBackgroundLayoutMain": "--color-background-layout-main-7zzes0",
    ...
    "colorBorderTabsUnderline": "--color-border-tabs-underline-b2155n",
    ...
    "colorTextAccent": "--color-text-accent-s51akt",
    ...
    "colorTextCalendarDateSelected": "--color-text-calendar-date-selected-l4zuqf",
    ...
    "colorTextExpandableSectionHover": "--color-text-expandable-section-hover-7rlili",
    ...
    "fontFamilyBase": "--font-family-base-0kmu7q",
