      ...
      "tools": [
        {
          ...
          {
                "name": "list_players",
                "description": "Query a database to retrieve a list of players and their scores.",
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "sort_by": {
                            "type": "string",
                            "enum" : ["kdr","games_played","avg_kills","avg_deaths"],
          ...
          {
            "name": "player_info",
                "description": "Query a database to retrieve stats on a player for each Valorant Agent they use.",
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "player_handle": {
