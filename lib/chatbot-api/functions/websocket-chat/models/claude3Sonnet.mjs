      ...
      "tools": [
        {
          ...
          {
                "name": "list_players",
                "description": "Query a database to retrieve a list of players and their scores. This is the first tool to use when assembling a team or doing anything that requires info on player performance.",
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "sort_by": {
                            "type": "string",
                            "enum" : ["avg_kdr","games_played","avg_kills","avg_deaths"],
