                  ...
                  "players": {
                    ...
                    "items": {
                      ...
                      "properties": {
                        ...
                        "agent": {
                          "type": "string",
                          "enum": ["astra", "breach", "brimstone", "chamber", "clove", "cypher", "deadlock", "fade", "gekko", "harbor", "iso", "jett", "kayo", "killjoy", "neon", "omen", "phoenix", "raze", "reyna", "sage", "skye", "sova", "viper", "vyse", "yoru"]
                        },
                        "role": {
                          "type": "string",
                          "enum": ["initiator", "controller", "sentinel", "duelist"]
                        },
                        "igl": { "type": "boolean" }
                      },
                    ...
                    "minItems": 5,
                    "maxItems": 5,
                    "description": "An array of 5 player objects. Make sure no player is repeated. Make sure no agent is repeated. Make sure no player is repeated. Make sure agent-role combinations are unique and correct. Also there should be only one IGL."
                  },
                  "teamVersion": {
                    "type": "number",
          ...
          "input_schema": {
            ...
            "properties": {
              "maps": {
                ...
                "description": "An object containing maps ranked by their suggestion order. All 3 maps must be unique and present."
              }
            },
            "required": ["maps"]
          }
