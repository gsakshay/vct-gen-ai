...
export default class ClaudeModel{
  ...
  "description": "Save the current team composition to the database for future reference. **Note: This should be the final tool used after assembling and finalizing the team composition.**",
  "input_schema": {
    "type": "object",
    "properties": {
      "team_composition": {
