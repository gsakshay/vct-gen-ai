      ...
      "tools": [
        {
          ...
          {
            "name": "return_json",
                "description": "Return the JSON representation of the team. If the user asked for a team composition, only then use this after building out the team. This will be the last tool you use.",
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "team_data": {
                            "type": "string",
                            "description": "The full info about the team, provide as much information as possible in natural language. This input will be turned into JSON by another LLM."
                        }
                    },
                    "required": [
                        "team_data"
