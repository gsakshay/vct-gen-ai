...
export default class ClaudeModel{
  ...
  "description": "Save the team composition to the database. This is necessary to save the team composition for future reference.",
  "input_schema": {
    "type": "object",
    "properties": {
      "team_composition": {
  ...
  "description": "Retrieve a previously saved team composition from the database, if you want to save the team composition for future reference update the version.",
  "input_schema": {
    "type": "object",
    "properties": {
    },
