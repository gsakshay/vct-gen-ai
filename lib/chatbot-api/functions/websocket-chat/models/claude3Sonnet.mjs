      ...
      "tools": [
        {
                ...
                "input_schema": {
                    ...
                    "properties": {
                        ...
                        "tournament" : {
                          ...
                          "description" : "The tournament you want to get the player data for."
                        }
          ...
          "description": "Save the team composition to the database. Use this after composing a team.",
          "input_schema": {
            "type": "object",
            "properties": {
              "session_id": {
                "type": "string",
                "description": "The session ID associated with this team composition."
              },
              "user_id": {
                "type": "string",
                "description": "The user ID of the person requesting the team composition."
              },
              "team_composition": {
                "type": "object",
                "properties": {
            ...
            "required": ["session_id", "user_id", "team_composition"]
          }
        },
          {
          "name": "get_team_composition",
          "description": "Retrieve a previously saved team composition from the database.",
          "input_schema": {
            "type": "object",
            "properties": {
              "session_id": {
                "type": "string",
                "description": "The session ID associated with the desired team composition."
              },
              "user_id": {
                "type": "string",
                "description": "The user ID of the person requesting the team composition."
