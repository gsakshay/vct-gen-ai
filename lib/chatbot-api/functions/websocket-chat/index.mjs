...
const getUserResponse = async (id, requestJSON) => {
  try {
    ...
    let history = claude.assembleHistory(lastFiveMessages, "Please answer this new question. Enclose thought processes in <thinking> tags. When naming agents, enclose them in <agent> tags with relevant properties. Players should get a <player> tag.".concat(userMessage))
