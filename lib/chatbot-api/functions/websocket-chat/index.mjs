          ...
          if (parsedChunk) {
            ...
            if (usingTool) {
              ...
              if (toolUse.name == "query_db") {
                ...
                const saveMapResult = await saveMap(data.session_id, data.user_id, toolUse.input.maps); // Changed from map to maps
                ...
                toolResult = JSON.stringify(getMapResult.maps) || "Maps not found."; // Changed to 'maps'
              }
