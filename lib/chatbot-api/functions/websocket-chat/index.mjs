...
- **Output Format:**
  ...
  - Only give the requested information and do not include any additional data. i.e., { "players": [ { "Name": "Player1", "Role": "Offensive", "Agent Category": "Duelist", "IGL Status": true, "Statistics": { "KDA": 1.2, "ACS": 200 } }, { "Name": "Player2", "Role": "Defensive", "Agent Category": "Sentinel", "IGL Status": false, "Statistics": { "KDA": 1.1, "ACS": 180 } } ] }
...
Please output only the JSON structure .
  ...
  for (const word in jsonResponse.split('')){
    responseParams = {
      ConnectionId: id,
      Data: word
    }  
